...
const AdminList = () => {
  ...
  const calculateAvgRating = (selectedUser) => {
    ...
    selectedUser?.ratingsOfTeacher?.forEach((ratingObj) => {
  ...
  const avgRating = calculateAvgRating(selectedUser);
  // console.log(avgRating);
  return (
    <div className="mt-32 ml-0 sm:ml-52 lg:ml-64">
      <div className="relative overflow-x-auto shadow-[0_4px_10px_rgba(0,0,0,0.3)] sm:rounded-lg sm:p-12 sm:m-5">
            ...
            {admins?.map((admin, index) => {
              return (
                ...
                >
                  <th
                    scope="row"
                    className="flex items-center cursor-pointer gap-2 px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"
                  ...
                  <td className="px-6 py-4">
                    {admin.userUniqueId || "No Available"}
                  </td>
                  <td className="px-6 py-4">
                    {admin.specialization || "Web Devloper"}
                  </td>
                  <td className="px-6 py-4">{admin.email}</td>
                  <td className="px-6 py-4">
                    {admin.dateOfJoining || "2025/01/08"}
                  </td>
                  <td className="px-6 py-4">
                    ${admin.salary || "$2999/"}/
                    <span className="text-xsm">m</span>
                  </td>
                  <td className="px-6 py-4 flex items-center gap-3">
                    <Link to="" className="text-red-500 dark:text-blue-500">
                      <svg
                        ...
                        width={26}
                        height={26}
                        onClick={() => handleOpenDeleteModal(admin._id)}
                      >
                        <path
                          fill="currentColor"
                ...
                <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-3xl">
                  <div className="grid grid-cols-1 sm:grid-cols-12">
                    <div className="col-span-1 sm:col-span-5">
                      ...
                      <div className="bg-[#444] border-b border-gray-600">
                        <span className="py-4 flex items-center pl-8 gap-x-3">
                      ...
                      <div className="bg-[#444] flex items-center pl-8 py-4">
                        {Array.from({ length: 5 }, (_, index) => (
                          ...
                          >
                            <path
                              fill={index < avgRating ? "#f90" : "#b7b0b0"}
...

{
  /* <div className="flex items-center justify-between bg-gradient-to-l from-slate-400 to-slate-700">
                    ...
                    <div className="py-5 px-6 text-start grid grid-cols-6">
